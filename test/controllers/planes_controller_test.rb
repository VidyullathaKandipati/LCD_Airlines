...
class PlanesControllerTest < ActionController::TestCase
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post :create, plane: { cols: @plane.cols, integer: @plane.integer, name: @plane.name, rows: @plane.rows }
    end
  ...
  test "should update plane" do
    patch :update, id: @plane, plane: { cols: @plane.cols, integer: @plane.integer, name: @plane.name, rows: @plane.rows }
    assert_redirected_to plane_path(assigns(:plane))
  end
